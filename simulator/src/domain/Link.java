...
public class Link {
    ...
    void sendPacket(Packet packet, RunInfo runInfo) {
        Double packetLoss = calculatePacketLoss(runInfo);

        // System.out.println(this + ": packetLoss" + packetLoss);
        Double randvalue = Math.random() * 100.0; // for debug purpose extra line
...
//			 /System.out.println("packet is lost");
            ...
            direction.storeLostPacket(packet, runInfo);
            PacketLinkCombination pkl = new PacketLinkCombination(packet, this,runInfo.getRunNumber());
            direction.storeLostPacketLinkStore(pkl, runInfo);
        }
    }
