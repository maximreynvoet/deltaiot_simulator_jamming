...
public class DeltaIoTSimulator {
        ...
        static Double snr_middle_window = 2.5;
        public static Simulator simul;

        // drift
        public static void resetDrift() {
                Mote mote2 = simul.getMoteWithId(2);
                Mote mote3 = simul.getMoteWithId(3);
                Mote mote4 = simul.getMoteWithId(4);
                Mote mote5 = simul.getMoteWithId(5);
                Mote mote6 = simul.getMoteWithId(6);
                Mote mote7 = simul.getMoteWithId(7);
                Mote mote8 = simul.getMoteWithId(8);
                Mote mote9 = simul.getMoteWithId(9);
                Mote mote10 = simul.getMoteWithId(10);
                Mote mote11 = simul.getMoteWithId(11);
                Mote mote12 = simul.getMoteWithId(12);
                Mote mote13 = simul.getMoteWithId(13);
                Mote mote14 = simul.getMoteWithId(14);
                Mote mote15 = simul.getMoteWithId(15);
                Gateway gateway = simul.getGatewayWithId(1);
        ...
        public static void drift(Double driftRatio) {
                ...
                mote2.getLinkTo(mote4).setSnrEquation(new SNREquation(0.0169 * driftRatio, 7.4076));
                mote3.getLinkTo(gateway).setSnrEquation(new SNREquation(0.4982 * driftRatio, 1.2468));
                mote4.getLinkTo(gateway).setSnrEquation(new SNREquation(0.8282 * driftRatio, -8.1246));
                mote5.getLinkTo(mote9).setSnrEquation(new SNREquation(0.4932 * driftRatio, -4.4898));
                mote6.getLinkTo(mote4).setSnrEquation(new SNREquation(0.6199 * driftRatio, -9.8051));
                mote7.getLinkTo(mote3).setSnrEquation(new SNREquation(0.5855 * driftRatio, -6.644));
                mote7.getLinkTo(mote2).setSnrEquation(new SNREquation(0.5398 * driftRatio, -2.0549));
                mote8.getLinkTo(gateway).setSnrEquation(new SNREquation(0.5298 * driftRatio, -0.1031));
                mote9.getLinkTo(gateway).setSnrEquation(new SNREquation(0.8284 * driftRatio, -7.2893));
                mote10.getLinkTo(mote6).setSnrEquation(new SNREquation(0.8219 * driftRatio, -7.3331));
                mote10.getLinkTo(mote5).setSnrEquation(new SNREquation(0.6463 * driftRatio, -3.0037));
                mote11.getLinkTo(mote7).setSnrEquation(new SNREquation(0.714 * driftRatio, -3.1985));
                mote12.getLinkTo(mote7).setSnrEquation(new SNREquation(0.9254 * driftRatio, -16.21));
                mote12.getLinkTo(mote3).setSnrEquation(new SNREquation(0.1 * driftRatio, 6));
                mote13.getLinkTo(mote11).setSnrEquation(new SNREquation(0.6078 * driftRatio, -3.6005));
                mote14.getLinkTo(mote12).setSnrEquation(new SNREquation(0.4886 * driftRatio, -4.7704));
                mote15.getLinkTo(mote12).setSnrEquation(new SNREquation(0.5899 * driftRatio, -7.1896));

        }

        public DeltaIoTSimulator() {
                simul = createSimulatorForDeltaIoT();
        ...
        public static Simulator createSimulatorForDeltaIoT() {
                ...
                // creation of simulator initializes channelconfig as BASIC (via config)
                String channelConfigMode = "SINGLE";
                ChannelConfiguration chConfig = new ChannelConfiguration(channelConfigMode);
                simul.setChannelconfig(chConfig); // we always start with single mode, mitigation in case of jamming can
                                                  // extend channels
                simul.setActiveChannelFrequency(chConfig.getChannelConfig().get("CH_13_868")); // standard channel
                ...
                double posScale = 1; // was 2 originally, however leads to incorrect rssi calculations
                Mote mote2 = new Mote(2, battery, load, maxQueueSize, keepAliveTime,
                                new Position(378 * posScale, 193 * posScale), false, chConfig);
                Mote mote3 = new Mote(3, battery, load, maxQueueSize, keepAliveTime,
                                new Position(365 * posScale, 343 * posScale), false, chConfig);
                Mote mote4 = new Mote(4, battery, load, maxQueueSize, keepAliveTime,
                                new Position(508 * posScale, 296 * posScale), false, chConfig);
                Mote mote5 = new Mote(5, battery, load, maxQueueSize, keepAliveTime,
                                new Position(603 * posScale, 440 * posScale), false, chConfig);
                Mote mote6 = new Mote(6, battery, load, maxQueueSize, keepAliveTime,
                                new Position(628 * posScale, 309 * posScale), false, chConfig);
                Mote mote7 = new Mote(7, battery, load, maxQueueSize, keepAliveTime,
                                new Position(324 * posScale, 273 * posScale), false, chConfig);
                Mote mote8 = new Mote(8, battery, load, maxQueueSize, keepAliveTime,
                                new Position(392 * posScale, 478 * posScale), true, chConfig);
                Mote mote9 = new Mote(9, battery, load, maxQueueSize, keepAliveTime,
                                new Position(540 * posScale, 479 * posScale), false, chConfig);
                Mote mote10 = new Mote(10, battery, load, maxQueueSize, keepAliveTime,
                                new Position(694 * posScale, 356 * posScale), true, chConfig);
                Mote mote11 = new Mote(11, battery, load, maxQueueSize, keepAliveTime,
                                new Position(234 * posScale, 232 * posScale), false, chConfig);
                Mote mote12 = new Mote(12, battery, load, maxQueueSize, keepAliveTime,
                                new Position(221 * posScale, 322 * posScale), false, chConfig);
                Mote mote13 = new Mote(13, battery, load, maxQueueSize, keepAliveTime,
                                new Position(142 * posScale, 170 * posScale), true, chConfig);
                Mote mote14 = new Mote(14, battery, load, maxQueueSize, keepAliveTime,
                                new Position(139 * posScale, 293 * posScale), true, chConfig);
                Mote mote15 = new Mote(15, battery, load, maxQueueSize, keepAliveTime,
                                new Position(128 * posScale, 344 * posScale), true, chConfig);

                Mote[] allMotes = new Mote[] { mote2, mote3, mote4, mote5, mote6, mote7, mote8, mote9, mote10, mote11,
                                mote12,
                ...
                mote2.setActivationProbability(new Constant<>(0.75));
                mote4.setActivationProbability(new Constant<>(0.60));
                mote8.setActivationProbability(new Constant<>(0.80));
                // mote10.setActivationProbability(new
                // FileProfile("deltaiot/scenario_data/PIR1.txt", 1.0));
                // mote13.setActivationProbability(new
                // FileProfile("deltaiot/scenario_data/PIR2.txt", 1.0));
                mote10.setActivationProbability(new Constant<>(.20));
                mote13.setActivationProbability(new Constant<>(.30));
                mote14.setActivationProbability(new Constant<>(1.0));

                // 5,7,11,12 RFID sensors
                mote5.setActivationProbability(new Constant<>(0.50));
                mote7.setActivationProbability(new Constant<>(0.75));
                mote11.setActivationProbability(new Constant<>(0.50));
                mote12.setActivationProbability(new Constant<>(0.75));
                ...
                mote3.getLinkTo(gateway).setSnrEquation(new SNREquation(0.4982, 1.2468));
                mote4.getLinkTo(gateway).setSnrEquation(new SNREquation(0.8282, -8.1246));
                mote5.getLinkTo(mote9).setSnrEquation(new SNREquation(0.4932, -2.4898)); // -4.4898
                mote6.getLinkTo(mote4).setSnrEquation(new SNREquation(0.6199, -4.8051)); // -9.8051
                mote7.getLinkTo(mote3).setSnrEquation(new SNREquation(0.5855, -2.644)); // -6.644
                mote7.getLinkTo(mote2).setSnrEquation(new SNREquation(0.5398, -2.0549));
                mote8.getLinkTo(gateway).setSnrEquation(new SNREquation(0.5298, -0.1031));
                mote9.getLinkTo(gateway).setSnrEquation(new SNREquation(0.8284, -7.2893));
                mote10.getLinkTo(mote6).setSnrEquation(new SNREquation(0.8219, -7.3331));
                mote10.getLinkTo(mote5).setSnrEquation(new SNREquation(0.6463, -3.0037));
                mote11.getLinkTo(mote7).setSnrEquation(new SNREquation(0.714, -3.1985));
                mote12.getLinkTo(mote7).setSnrEquation(new SNREquation(0.7254, -8.21)); // -16.12
                mote12.getLinkTo(mote3).setSnrEquation(new SNREquation(0.1, 6));
                mote13.getLinkTo(mote11).setSnrEquation(new SNREquation(0.6078, -3.6005));
                mote14.getLinkTo(mote12).setSnrEquation(new SNREquation(0.4886, -4.7704));
                mote15.getLinkTo(mote12).setSnrEquation(new SNREquation(0.5899, -5.1896)); // -7.1896
                ...
                double step = 1.5;
                double max_snr_val = 20.0;
                double min_snr_val = 2.5;
                int max_snr_cycle = 450;
               
                // simul.getRunInfo().setGlobalInterference(new DoubleRange(1.0,
                // snr_middle_window + step));
                simul.setMaxTimeSlots(maxQueueSlots);
                
                snr_middle_window = min_snr_val
                                + Math.abs(Math.sin((cycle_counter * 1.0) / max_snr_cycle * Math.PI / 2))
                                                * (max_snr_val - min_snr_val);
                System.out.println("middle_window: " + snr_middle_window.toString());
                simul.getRunInfo().setGlobalInterference(
                        new DoubleRange(snr_middle_window - step, snr_middle_window + step));
                cycle_counter += 1;
        ...
        public static Simulator createSimulatorForDeltaIoTv2() {
                ...
                for (int i = 2; i < 38; i++) {
                        motes.add(new Mote(i, battery, load, maxQueueSize, keepAliveTime,
                                        new Position(i * posScale, i * posScale), leafMotes.contains(i)));
                }
                ...
                // allMotes[7-2].addLinkTo(allMotes[8-2], gateway, power, packetDuplication ?
                // 100 : 50);
                ...
                // Set order
                simul.setTurnOrder(7, 9, 13, 16, 24, 34, 35, 36, 37, 2, 8, 14, 17, 19, 22, 27, 30, 32, 33, 3, 18, 23,
                                25, 26, 28, 29, 31, 4, 6, 15, 20, 21, 5, 10, 11, 12);
                ...
                // allMotes[7-2].getLinkTo(allMotes[8-2]).setSnrEquation(new
                // SNREquation(0.4085,-2.6870));
                ...
                // allMotes[20-2].getLinkTo(allMotes[32-2]).setSnrEquation(new
                // SNREquation(0.6085,-2.6870));
                ...
                simul.getRunInfo().setGlobalInterference(new DoubleRange(1.0, 18.0));
                simul.setMaxTimeSlots(maxQueueSlots);
                return simul;
        }
        ...
        public static deltaiot.services.Mote getAfMote(Mote mote, Simulator simul) {
                ...
                for (Link link : mote.getLinks()) {
                        ...
                        Double dpacketloss = link.calculatePacketLoss(simul.getRunInfo());
                        int packetLoss = dpacketloss.intValue();
                        ...
                        deltaiot.services.Link afLink = new deltaiot.services.Link(latency, power, packetLoss, source,
                                        dest, sNR,
                                        distribution, sF);
                        afLinks.add(afLink);
                }

                deltaiot.services.Mote afMote = new deltaiot.services.Mote(moteid, load, battery, parents,
                                dataProbability,
        ...
        public static Simulator createSimulatorForTraining(int[] distributions, int[] powers, double globalInterference,
                ...
                SNREquation[] snrEquations = new SNREquation[] { new SNREquation(0.0169, 7.4076),
                                new SNREquation(0.4982, 1.2468), new SNREquation(0.8282, -8.1246),
                                new SNREquation(0.4932, -4.4898),
                                new SNREquation(0.6199, -9.8051), new SNREquation(0.5855, -6.644),
                                new SNREquation(0.5398, -2.0549),
                                new SNREquation(0.5298, -0.1031), new SNREquation(0.8284, -7.2893),
                                new SNREquation(0.8219, -7.3331),
                                new SNREquation(0.6463, -3.0037), new SNREquation(0.714, -3.1985),
                                new SNREquation(0.9254, -16.21),
                                new SNREquation(0.1, 6), new SNREquation(0.6078, -3.6005),
                                new SNREquation(0.4886, -4.7704),
        ...
        public void applyNewSettings(String msgSettings) {
                ...
                if (msgSettings.equalsIgnoreCase("NoAdaptationRequired")
                        ...
                        Gson gson = new Gson();
                        deltaiot.services.Mote afMote = gson.fromJson(msgSettings,
                                        new TypeToken<deltaiot.services.Mote>() {
                                        }.getType());
