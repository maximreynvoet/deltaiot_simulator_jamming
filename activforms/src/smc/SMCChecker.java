...
public class SMCChecker {
    ...
    //         "./", "uppaal-verifyta", "verifyta -a %f -E %f -u %s").toString();

    public static String command = Paths.get(System.getProperty("user.dir") , "/uppaal-verifyta", "verifyta -a %f -E %f -u %s").toString();
